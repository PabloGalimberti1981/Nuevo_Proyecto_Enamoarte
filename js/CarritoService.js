...
function agregarAlCarrito(producto){
  ...
  let memoria = JSON.parse(localStorage.getItem("CarritoTienda"));
  ...
  if(!memoria || memoria.length === 0) {
    ...
    const indiceProducto = memoria.findIndex(CarritoTienda => CarritoTienda.id === producto.id)
    ...
    localStorage.setItem("CarritoTienda",JSON.stringify(nuevaMemoria));
    actualizarNumeroCarrito();
